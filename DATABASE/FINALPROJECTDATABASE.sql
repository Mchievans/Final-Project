...
BULK INSERT USERS
FROM 'C:\FinalProject\DATABASE\USER.CSV'
WITH
(
FIRSTROW = 2,
DATAFILETYPE = 'char',
...
BULK INSERT SHOP
FROM 'C:\FinalProject\DATABASE\SHOP.CSV'
WITH
(
FIRSTROW = 2,
DATAFILETYPE = 'char',
...
FROM 'C:\FinalProject\DATABASE\MECHANICS.CSV'
WITH
(
FIRSTROW = 2,
DATAFILETYPE = 'char',
...
BULK INSERT VEHICLE
FROM 'C:\FinalProject\DATABASE\VEHICLE.CSV'
WITH
(
FIRSTROW = 2,
DATAFILETYPE = 'char',
...
BULK INSERT service
FROM 'C:\FinalProject\DATABASE\service.CSV'
WITH
(
FIRSTROW = 2,
DATAFILETYPE = 'char',
...
select ss.serviceid, s.shopid, ss.VEHICLEID, s.shopname, ss.estimatedpartsneed, 
ss.estimatedtotalprice 
from service ss  Join shop s on ss.shopid = s.shopid;